<template>
  <div class="bg-[#fef0e5] px-[23px] py-[23px] text-right">
    <span class="font-['Epilogue'] font-light text-sm leading-[120%] tracking-[0.1em]">March 7th, 2026</span>
  </div>
    ...
    <div class="max-w-[500px] mx-auto px-[23px]">
      <div class="flex flex-col gap-[60px]">
        ...
        <div class="leading-[150%] mb-[24px]">
          ...
          <br />
          <p>
            별도의 식순 없이 자유롭게 관람 가능하며, <br />오전 11시부터 오후 3시
            사이에 <br />
            편하신 시간에 방문해 주세요.
          </p>
        </div>
      ...
      <div>
        ...
        <div class="mt-[64px]">
          <img src="@/assets/hero-image.png" alt="Wedding Couple" class="w-full h-auto">
        </div>
      </div>
    </div>
  </section>
